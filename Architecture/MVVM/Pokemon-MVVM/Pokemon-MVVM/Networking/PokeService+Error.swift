...
extension PokeService.NetworkingError: Equatable {
    static func == (lhs: PokeService.NetworkingError,
                    rhs: PokeService.NetworkingError) -> Bool {
        switch(lhs, rhs) {
...
extension PokeService.NetworkingError {
